...
if (!postSlug) {
  ...
  Share:  <a href="https://twitter.com/intent/tweet?url=${url}&text=${article.title}" target="_blank" class="social-icon">
    <i class="fa-brands fa-x-twitter"></i>
  </a>

  <a href="https://www.linkedin.com/sharing/share-offsite/?url=${url}" target="_blank" class="social-icon">
  ...
  <a href="https://wa.me/?text=${url}" target="_blank" class="social-icon">
